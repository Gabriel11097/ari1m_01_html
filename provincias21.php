...
<center><h1>Ejercicio 21</h1></center>
<center><h2>Población del pais</h2></center>
<?php
$poblacion=0;
foreach ($provincias as $p){
	$poblacion +=$p["poblacion"];
}
echo "La población total de España es: ".$poblacion;
?>
<div id="sp"></div>
<script>
pobla=0;
for(p=0; p<provincias.length ; p++){
	pobla=parseInt(pobla)+ parseInt(provincias[p]["poblacion"]);
}
document.getElementById("sp").innerHTML="La población total de España es: " +pobla ;
</script>