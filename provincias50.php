...
<center><h2>Provincia más poblada de la autonomía más despoblada</h2></center>
<?php
$autonomias=[];
...
foreach($provincias as $p){
$a=$p["autonomia"];
$autonomias[$a]=$autonomias[$a]+$p["poblacion"];
}
echo min($autonomias);
foreach($autonomias as $a=>$poblacion)
if(min($autonomias)==$poblacion)
	echo " ". $a;
?>
<script>
